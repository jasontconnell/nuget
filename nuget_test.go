...
// 	urls := []string{"http://nuget.episerver.com/feed/packages.svc/", "https://api.nuget.org/v3/index.json"}

// 	tests := []struct{ id string }{{id: "Microsoft.Tpl.Dataflow"}, {id: "EPiServer.CMS"}}

// 	for _, test := range tests {
// 		res, err := FindPackage(urls, test.id)
// 		if err != nil {
// 			t.Error(err)
// 		}
// 		t.Log(res)
...
// 		{id: "Microsoft.AspNet.Mvc", version: "5.2.4", result: true},
// 	}
